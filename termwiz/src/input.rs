...
use std::fmt::Write;
use thothterm_input_types::ctrl_mapping;

pub use thothterm_input_types::Modifiers;
...
pub use thothterm_escape_parser::csi::MouseButtons;
            ...
            match self.state {
                InputState::Pasting(offset) => {
                    ...
                    if let Some(idx) = self.buf.find_subsequence(offset, end_paste) {
                        ...
                        // <https://github.com/thothterm/thothterm/pull/1832>
                        self.state =
