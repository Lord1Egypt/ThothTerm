...
//! used by [thothterm](https://thothterm.org/).  The home for this
//! crate is in the thothterm repo and development is tracked at
//! <https://github.com/thothterm/thothterm/>.
//!
...
use thothterm_surface::SequenceNo;
...
pub use thothterm_cell::*;
pub use thothterm_surface::line::*;
...
pub struct CursorPosition {
    ...
    pub shape: thothterm_surface::CursorShape,
    pub visibility: thothterm_surface::CursorVisibility,
