...
use ::image::RgbaImage;
use thothterm_cell::color::RgbColor;
use thothterm_cell::image::ImageDataType;
use thothterm_escape_parser::{Sixel, SixelData};
        ...
        for d in &sixel.data {
            match d {
                ...
                SixelData::DefineColorMapHSL {
                    ...
                    // https://github.com/thothterm/thothterm/issues/775
