...
use thothterm_surface::{Line, SequenceNo};
...
impl Default for NewlineCanon {
    fn default() -> Self {
        ...
        //
        // To come to a compromise, if thothterm is running on Windows then we'll
        ...
        if cfg!(windows) {
            ...
            // <https://github.com/thothterm/thothterm/issues/1575>
            Self::CarriageReturn
        }
    }
}
