...
use thothterm_color_types::SrgbaTuple;
use thothterm_font::{FontConfiguration, FontMetrics, GlyphInfo, RasterizedGlyph};
use thothterm_input_types::WindowDecorations;
    ...
    fn reshape_title(&mut self) -> Option<()> {
        ...
        let infos = font
            .shape(
                ...
                None,
                thothterm_bidi::Direction::LeftToRight,
                None,
                None,
            )
            .ok()?;
