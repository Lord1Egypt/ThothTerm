fn main() {
    ...
    #[cfg(windows)]
    {
        ...
        // version number that we report in thothterm -h.
...
BEGIN
    ...
    BEGIN
        BLOCK "040904E4"
        BEGIN
            VALUE "CompanyName",      "Mohamed Mounir (Lord1Egypt)\0"
            VALUE "FileDescription",  "ThothTerm - GPU-accelerated terminal emulator\0"
            VALUE "FileVersion",      "{version}\0"
            VALUE "LegalCopyright",   "Mohamed Mounir, MIT licensed\0"
            VALUE "InternalName",     "\0"
            VALUE "OriginalFilename", "\0"
            VALUE "ProductName",      "ThothTerm\0"
...
"#,
    ...
    #[cfg(target_os = "macos")]
    {
        ...
        println!("cargo:rerun-if-changed=assets/macos/ThothTerm.app/Contents/Info.plist");
