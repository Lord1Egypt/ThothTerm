...
use thothterm_blob_leases::{BlobLease, BlobManager, BoxedReader};
use thothterm_font::units::*;
use thothterm_font::{FontConfiguration, GlyphInfo, LoadedFont, LoadedFontId};
use thothterm_term::Underline;
...
impl GlyphCache {
    ...
    fn load_glyph(
        ...
        // can happen somehow; see <https://github.com/thothterm/thothterm/issues/1042>
        ...
        match &*handle.h {
            ...
            ImageDataType::AnimRgba8 {
                ...
                if frames.len() > 1 {
                    ...
                    // frame duration that thothterm can use when rendering.
                    ...
                    // <https://github.com/thothterm/thothterm/issues/3260>
