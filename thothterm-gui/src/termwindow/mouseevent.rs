...
use thothterm_dynamic::ToDynamic;
use thothterm_term::input::{MouseButton, MouseEventKind as TMEK};
use thothterm_term::{ClickPosition, LastMouseClick, StableRowIndex};
...
impl super::TermWindow {
    ...
    fn mouse_event_terminal(
        ...
        let mouse_event = thothterm_term::MouseEvent {
