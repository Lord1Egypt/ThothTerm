...
use thothterm_cell::color::ColorAttribute;
#[cfg(feature = "use_image")]
use thothterm_cell::image::ImageCell;
use thothterm_cell::{Cell, CellAttributes};
...
mod test {
    use super::*;
    use alloc::sync::Arc;
    use thothterm_cell::color::AnsiColor;
    use thothterm_cell::image::ImageData;
    use thothterm_cell::{AttributeChange, Intensity};
