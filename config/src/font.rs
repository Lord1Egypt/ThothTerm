...
use std::fmt::Display;
use thothterm_dynamic::{FromDynamic, FromDynamicOptions, ToDynamic, Value};
        ...
        match value {
            ...
            other => {
                if let Some(value) = value.coerce_unsigned() {
                    ...
                    Err(thothterm_dynamic::Error::NoConversion {
...
impl std::fmt::Display for FontAttributes {
    fn fmt(&self, fmt: &mut std::fmt::Formatter) -> Result<(), std::fmt::Error> {
        write!(
            fmt,
            "thothterm.font('{}', {{weight={}, stretch='{}', style={}}})",
...
impl TextStyle {
    ...
    ///
    /// <https://github.com/thothterm/thothterm/issues/456>
...
pub struct StyleRule {
    ...
    /// "Half".
    pub intensity: Option<thothterm_term::Intensity>,
    ...
    /// "Double".
    pub underline: Option<thothterm_term::Underline>,
    ...
    /// a value that matches this rule.
    pub blink: Option<thothterm_term::Blink>,
