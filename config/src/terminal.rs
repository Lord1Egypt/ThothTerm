...
use thothterm_term::config::BidiMode;
...
impl thothterm_term::TerminalConfiguration for TermConfig {
    ...
    fn canonicalize_pasted_newlines(&self) -> thothterm_term::config::NewlineCanon {
        match self.configuration().canonicalize_pasted_newlines {
            None => thothterm_term::config::NewlineCanon::default(),
            Some(NewlineCanon::None) => thothterm_term::config::NewlineCanon::None,
            Some(NewlineCanon::LineFeed) => thothterm_term::config::NewlineCanon::LineFeed,
            Some(NewlineCanon::CarriageReturn) => {
                thothterm_term::config::NewlineCanon::CarriageReturn
            }
            Some(NewlineCanon::CarriageReturnAndLineFeed) => {
                thothterm_term::config::NewlineCanon::CarriageReturnAndLineFeed
            }
        }
    }
