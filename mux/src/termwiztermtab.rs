...
//! The idea is to use these when thothterm needs to request
...
pub struct TermWizTerminalPane {
    pane_id: PaneId,
    domain_id: DomainId,
    terminal: Mutex<thothterm_term::Terminal>,
...
impl TermWizTerminalPane {
    fn new(
        ...
        let terminal = Mutex::new(thothterm_term::Terminal::new(
            size,
...
impl Pane for TermWizTerminalPane {
    ...
    fn mouse_event(&self, event: MouseEvent) -> anyhow::Result<()> {
        ...
        use thothterm_term::input::MouseButton;
