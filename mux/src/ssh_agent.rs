...
/// AgentProxy manages an agent.PID symlink in the thothterm runtime
/// directory.
...
///
/// As a further complication, when a thothterm proxy client is
...
impl AgentProxy {
    ...
    fn update_now(&self) {
        ...
        clients.sort_by(|a, b| {
            ...
            // in thothterm-mux-server-impl/src/sessionhandler.rs
