...
use std::sync::Arc;
use url::Url;
use thothterm_term::{StableRowIndex, TerminalSize};
...
impl TabInner {
        ...
        !self
            .remove_pane_if(
                |_, pane| {
                    ...
                    // <https://github.com/thothterm/thothterm/issues/4030>
    ...
    fn compute_split_size(
        ...
        // a bogus split state (https://github.com/thothterm/thothterm/issues/723)
...
mod test {
    ...
    use thothterm_term::{KeyCode, KeyModifiers, Line, MouseEvent, StableRowIndex};
