...
/// on most systems.  This list was assembled by researching keyboard
/// documentation to cover all keys that might be possible.
...
bitflags! {
    ...
    pub struct Modifiers: u16 {
        ...
        const LEFT_ALT = 1<<5;
        const RIGHT_ALT = 1<<6;
        /// This is a virtual modifier used by thothterm
        const LEADER = 1<<7;
        const LEFT_CTRL = 1<<8;
...
impl KeyEvent {
    ...
    pub fn encode_kitty(&self, flags: KittyKeyboardFlags) -> String {
        ...
        // See: https://github.com/thothterm/thothterm/pull/4605#issuecomment-1823604708
...
impl FromDynamic for IntegratedTitleButtonStyle {
    fn from_dynamic(
        ...
        _options: thothterm_dynamic::FromDynamicOptions,
        ...
        Self: Sized,
    {
        ...
        if let thothterm_dynamic::Value::String(string) = value {
            let style = match string.as_str() {
                "Windows" => Self::Windows,
                "Gnome" => Self::Gnome,
                "MacOsNative" if cfg!(target_os = "macos") => Self::MacOsNative,
                _ => {
                    return Err(thothterm_dynamic::Error::InvalidVariantForType {
            ...
            Err(thothterm_dynamic::Error::InvalidVariantForType {
